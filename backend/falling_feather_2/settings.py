"""
Django settings for falling_feather_2 project.
...
ROOT_URLCONF = 'falling_feather_2.urls'
...
WSGI_APPLICATION = 'falling_feather_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Falling Feather Support <support@falling-feather-2.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_feather_2 API",
    "DESCRIPTION": "API documentation for falling_feather_2 App",
    "VERSION": "v1",
}
